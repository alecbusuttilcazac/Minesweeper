...
class Settings{
    ...
    static String filePath = (System.getProperty("user.dir"))+"\\data\\settings.json";
    ...
    // Yes, Java has several JSON libraries, such as org.json, Gson, and Jackson.
    // Here's an example using org.json (add org.json library to your project):


    // static void writeToJson() {
    //     try {
    //         File jsonFile = new File(System.getProperty("user.dir") + "\\data\\settings.json");
    //         JSONObject obj = new JSONObject();
    //         obj.put("numBombs", numBombs);
    //         obj.put("bombChar", bombChar);
    //         obj.put("flagChar", flagChar);
    //         if (debug) System.out.println("[settings.json updated successfully]");
    //     } catch (Exception e) {
    ...
    static void displayGUI(JFrame f){
